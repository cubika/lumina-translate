...
const nord: ThemeColors = {
  ...
  'surface-container-low':      h('#2E3440'),
  'surface-container':          h('#343A48'),
  'surface-container-high':     h('#3B4252'),
  'surface-container-highest':  h('#434C5E'),
...
const solarizedLight: ThemeColors = {
  ...
  'surface-container-low':      h('#F8F1DE'),
  'surface-container':          h('#EEE8D5'),
  'surface-container-high':     h('#E6DFCC'),
  'surface-container-highest':  h('#DDD6C3'),
  'surface-variant':            h('#EEE8D5'),
  'background':                 h('#FDF6E3'),
  'on-surface':                 h('#586E75'),
  'on-surface-variant':         h('#93A1A1'),
  'on-background':              h('#586E75'),
  'outline':                    h('#93A1A1'),
  'outline-variant':            h('#D6CDB5'),
